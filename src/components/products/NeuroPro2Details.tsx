...
const NeuroPro2Details: React.FC<NeuroPro2DetailsProps> = ({
  ...
  const keyFeatures = [
    {
      icon: <Shield className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600" />,
      title: "Medical grade technology",
      description: ""
    },
    {
      icon: <Users className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600" />,
      title: "Ideal for practitioners, biohackers and meditators",
      description: ""
    },
    {
  ...
  const renderTabContent = () => {
    if (activeTab === 'general') {
      return (
        <div className="space-y-8 sm:space-y-10 lg:space-y-12">
          {/* Overview & Benefits Section - MOBILE OPTIMIZED */}
          <div className="grid gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-12 items-start">
            ...
            <div className="space-y-4 sm:space-y-6 order-1 lg:order-2">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2 lg:gap-3">
                {["Focus", "Stress", "Memory", "Sleep", "Mental clarity", "Creativity", "Brain energy"].map((benefit) => (
                  <span key={benefit} className="px-2.5 sm:px-3 lg:px-4 py-1 sm:py-1.5 lg:py-2 border border-gray-400 rounded-full text-xs sm:text-sm text-gray-700">
                    {benefit}
                  </span>
                ))}
              </div>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="flex items-center space-x-2.5 sm:space-x-3">
                  ...
                  <span className="font-medium text-black text-sm sm:text-base">≈400% sunlight irradiance</span>
                </div>
                <div className="flex items-center space-x-2.5 sm:space-x-3">
          ...
          {/* What's in the box - MOBILE OPTIMIZED */}
                  ...
                  <div className="space-y-4 sm:space-y-6 order-2 lg:order-1">
                    ...
                    <div className="space-y-2.5 sm:space-y-3 lg:space-y-4">
                      {[
                        ...
                        <div key={index} className="flex items-center space-x-2.5 sm:space-x-3">
                          <div className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 bg-[#EA1934] text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold flex-shrink-0">
                            {index + 1}
                          </div>
          ...
          {/* User guides & tutorials - MOBILE OPTIMIZED */}
          <div className="bg-gray-200 rounded-xl sm:rounded-2xl overflow-hidden">
            <button
              onClick={() => toggleSection('user-guides')}
              className="w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-5 lg:py-6 flex items-center justify-between hover:bg-gray-300 transition-colors"
            ...
            {expandedSection === 'user-guides' && (
              <div className="px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8 space-y-6 sm:space-y-8">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 sm:gap-3 lg:gap-4">
                    {[
                      ...
                      <button
                        key={guide}
                        className="bg-[#EA1934] text-white px-3 sm:px-4 lg:px-6 py-2 sm:py-2.5 lg:py-3 rounded-full font-semibold hover:bg-blue-700 transition-colors text-xs sm:text-sm lg:text-base"
                      >
                        {guide}
                      </button>
                    ))}
                ...
                {/* Video tutorials section - MOBILE RESPONSIVE */}
                <div>
                  <h4 className="text-lg sm:text-xl font-bold text-[#EA1934] mb-4 sm:mb-6">Video tutorials</h4>

                  <div className="space-y-4 sm:space-y-6">
                    {/* Setup Walkthrough Video */}
                    <div className="relative rounded-xl sm:rounded-2xl overflow-hidden bg-gray-400">
                      <Image
                        src="/neuro-pro-2-setup-video-thumb.jpg"
                        alt="Neuro Pro 2 Setup Walkthrough"
                        width={800}
                      ...
                      />
                      <div className="absolute top-3 left-3 sm:top-6 sm:left-6 lg:top-8 lg:left-8">
                        <div className="text-black space-y-2 sm:space-y-3 lg:space-y-4">
                          <div>
                            <h5 className="text-sm sm:text-lg lg:text-2xl font-bold leading-tight">Neuro Pro 2 | Setup</h5>
                            <h5 className="text-sm sm:text-lg lg:text-2xl font-bold leading-tight">Walkthrough</h5>
                          </div>
                          <button
                            onClick={() => window.open('https://youtu.be/3UDQxZBDe5k', '_blank')}
                            className="flex items-center space-x-2 bg-white bg-opacity-80 px-3 sm:px-4 lg:px-6 py-2 sm:py-2.5 lg:py-3 rounded-full hover:bg-opacity-90 transition-colors border border-gray-400 text-xs sm:text-sm lg:text-base"
                          >
                            <Play className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-black" />
                            <span className="font-medium text-black">Watch the video</span>
                          </button>
                        </div>
                      </div>
                    ...
                    {/* Access Gracefire Protocols Video */}
                    <div className="relative rounded-xl sm:rounded-2xl overflow-hidden bg-gray-200">
                      <Image
                        src="/neuro-pro-2-protocols-video-thumb.jpg"
                        alt="Neuro Pro 2 Access Gracefire Protocols"
                        width={800}
                      ...
                      <div className="absolute top-3 left-3 sm:top-6 sm:left-6 lg:top-8 lg:left-8">
                        <div className="text-black space-y-2 sm:space-y-3 lg:space-y-4">
                          <div>
                            <h5 className="text-sm sm:text-lg lg:text-2xl font-bold leading-tight">Neuro Pro 2 | Access</h5>
                            <h5 className="text-sm sm:text-lg lg:text-2xl font-bold leading-tight">Gracefire Protocols</h5>
                          </div>
                          <button
                            onClick={() => window.open('https://youtu.be/W8DwjwdBAbg', '_blank')}
                            className="flex items-center space-x-2 bg-white bg-opacity-80 px-3 sm:px-4 lg:px-6 py-2 sm:py-2.5 lg:py-3 rounded-full hover:bg-opacity-90 transition-colors border border-gray-400 text-xs sm:text-sm lg:text-base"
    ...
    if (activeTab === 'device') {
      return (
        <div className="space-y-8 sm:space-y-10 lg:space-y-12">
          {/* The ultimate at-home photobiomodulation device - MOBILE RESPONSIVE */}
          <div className="grid gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="relative order-2 lg:order-1">
              <Image
                src="/neuro-pro-2-device-black-white.jpg"
            ...
            <div className="space-y-4 sm:space-y-6 order-1 lg:order-2">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#EA1934]">The ultimate at-home photobiomodulation device</h2>
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start space-x-2.5 sm:space-x-3">
                  <Sun className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 mt-0.5 sm:mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-black text-sm sm:text-base">Up to 400 mW/cm2 irradiance, 12,000 mW total power</p>
                    <p className="text-gray-600 text-sm">– the highest in the industry by a significant margin.</p>
                  </div>
                </div>

                <div className="flex items-start space-x-2.5 sm:space-x-3">
                  <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 mt-0.5 sm:mt-1 flex-shrink-0" />
                  <div>
                                        <p className="font-semibold text-black text-sm sm:text-base">12 programmable and powerful Vie-LED modules</p>
                    <p className="text-gray-600 text-sm">to target specific or all brain networks.</p>
                  </div>
                </div>

                <div className="flex items-start space-x-2.5 sm:space-x-3">
                  <Brain className="w-5 h-5 sm:w-6 sm:h-6 text-gray-600 mt-0.5 sm:mt-1 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-black text-sm sm:text-base">Featuring cross-frequency coupling</p>
                    <p className="text-gray-600 text-sm">frequency sweeps and neural network synchronization.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Customize your brain's potential - MOBILE RESPONSIVE */}
          <div className="grid gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="relative order-2 lg:order-1">
              <Image
                src="/neuro-pro-2-phone-control.jpg"
            ...
            <div className="space-y-4 sm:space-y-6 order-1 lg:order-2">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#EA1934]">Customize your brain's potential</h2>
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start space-x-2.5 sm:space-x-3">
                  <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gray-600 rounded-full flex items-center justify-center mt-0.5 sm:mt-1 flex-shrink-0">
                    <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-white rounded-full"></div>
                  </div>
                  <p className="font-semibold text-black text-sm sm:text-base">12,000 mW total power | 400 mW/cm2 irradiance</p>
                </div>
                ...
                <div className="flex items-start space-x-2.5 sm:space-x-3">
                  ...
                  <p className="font-semibold text-black text-sm sm:text-base">8 powerful preset protocols to modulate your brain, and the possibility to create your own</p>
                </div>
                ...
                <div className="flex items-start space-x-2.5 sm:space-x-3">
                  ...
                  <p className="font-semibold text-black text-sm sm:text-base">Activate Neuro Pro modules in any combination, including synchronized patterns.</p>
                </div>
                ...
                <div className="flex items-start space-x-2.5 sm:space-x-3">
                  ...
                  <p className="font-semibold text-black text-sm sm:text-base">Fully customizable session length, power intensity, phase asynchrony, duty cycle, and frequency pulse capabilities between 1 and 10,000 Hz.</p>
                </div>
              </div>
            </div>
          </div>

          {/* Shop Button - MOBILE CENTERED */}
          <div className="text-center">
            <button className="bg-[#EA1934] text-white px-6 sm:px-8 py-3 rounded-full font-semibold hover:bg-blue-700 transition-colors text-sm sm:text-base">
              Shop Neuro Pro 2 now
            </button>
          </div>

          {/* Ideal for neurofeedback providers - MOBILE RESPONSIVE */}
          <div className="text-center space-y-6 sm:space-y-8">
            <div className="space-y-3 sm:space-y-4">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black">Ideal for neurofeedback providers</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="text-center space-y-3 sm:space-y-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#EA1934]">Before</h3>
                <p className="text-gray-700 text-sm sm:text-base">Boost neuroplasticity and energy, preparing the brain for peak responsiveness.</p>
              </div>
              ...
              <div className="text-center space-y-3 sm:space-y-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#EA1934]">During</h3>
                <p className="text-gray-700 text-sm sm:text-base">Enhance focus and attention to maximize engagement and results.</p>
              </div>

              {/* After */}
              <div className="text-center space-y-3 sm:space-y-4 sm:col-span-3 md:col-span-1">
                <div className="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-3 sm:mb-4">
                  <Image
                    src="/brain-icon-after.png"
                    alt="After icon"
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#EA1934]">After</h3>
                <p className="text-gray-700 text-sm sm:text-base">Support relaxation and integration, helping clients solidify the benefits for lasting impact.</p>
              </div>
            </div>

            <button className="bg-[#EA1934] text-white px-6 sm:px-8 py-3 rounded-full font-semibold hover:bg-blue-700 transition-colors flex items-center space-x-2 mx-auto text-sm sm:text-base">
              <span>Read Neuro Pro 2 Practitioners Guide</span>
    ...
    if (activeTab === 'app') {
      return (
        <div className="space-y-8 sm:space-y-10 lg:space-y-12">
          {/* How to use the Neuro Pro App - MOBILE RESPONSIVE */}
          <div className="text-center space-y-6 sm:space-y-8">
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black">How to use the Neuro Pro App</h2>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              {/* Connect */}
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center space-y-3 sm:space-y-4">
                <div className="relative mx-auto w-32 sm:w-40 lg:w-48 h-48 sm:h-64 lg:h-80">
                  <Image
                    src="/neuro-pro-app-connect-screen.jpg"
                    alt="Connect app screen"
                    fill
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#EA1934]">Connect</h3>
                <p className="text-black font-semibold text-sm sm:text-base">Connect your Neuro Pro with the Neuro Pro app.</p>
                <p className="text-gray-700 text-xs sm:text-sm">The Neuro Pro comes with a pre-synced smartphone and the Neuro Pro App pre-installed.</p>
              </div>
              ...
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center space-y-3 sm:space-y-4">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#EA1934]">Customize</h3>
                <p className="text-black font-semibold text-sm sm:text-base">Customize parameters and adjust stimulation options to suit your needs.</p>
                <p className="text-gray-700 text-xs sm:text-sm">The Neuro Pro 2 comes with 8 advanced pre-set neurofeedback protocols to choose from and guides to choose which suits you best.</p>
              </div>

              {/* Save */}
              <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 text-center space-y-3 sm:space-y-4 sm:col-span-2 lg:col-span-1">
                <div className="relative mx-auto w-32 sm:w-40 lg:w-48 h-48 sm:h-64 lg:h-80">
                  <Image
                    src="/neuro-pro-app-save-screen.jpg"
                    alt="Save app screen"
                ...
                <h3 className="text-lg sm:text-xl font-bold text-[#EA1934]">Save</h3>
                <p className="text-black font-semibold text-sm sm:text-base">Easily save and categorize different settings into profiles.</p>
                <p className="text-gray-700 text-xs sm:text-sm">Load a given profile with a simple press of a button.</p>
              </div>
            </div>
          </div>

          {/* Preset protocols with image - MOBILE RESPONSIVE */}
          <div className="grid gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="relative overflow-hidden text-white order-2 lg:order-1">
              <Image
                src="/neuro-pro-protocols-devices.jpg"
                alt="Neuro Pro protocols devices"
                width={600}
            ...
            <div className="space-y-4 sm:space-y-6 order-1 lg:order-2">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#EA1934]">Preset protocols</h2>
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                The Neuro Pro App features <strong>8 advanced preset protocols</strong>, designed by leading neuroscientists, that extend beyond just Alpha and Gamma frequencies.
              </p>
              <button className="bg-[#EA1934] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-full font-semibold hover:bg-blue-700 transition-colors text-sm sm:text-base">
                See protocols
              </button>
            </div>
          </div>

          {/* Manual features - MOBILE RESPONSIVE */}
          <div className="grid gap-6 sm:gap-8 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="relative order-2 lg:order-1">
              <Image
                src="/neuro-pro-manual-control-screen.jpg"
            ...
            <div className="space-y-4 sm:space-y-6 order-1 lg:order-2">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#EA1934]">Manual features</h2>
              <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                Looking for more control? The Neuro Pro also offers manual exploration of brain networks and parameters, giving you the ability to customize:
              </p>
              ...
              <ul className="space-y-2 sm:space-y-3">
                {[
                  ...
                  <li key={feature} className="flex items-center space-x-2.5 sm:space-x-3">
                    <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 bg-black rounded-full flex-shrink-0"></div>
                    <span className="text-black font-medium text-sm sm:text-base">{feature}</span>
                  </li>
                ))}
              </ul>
            </div>
  ...
  return (
    <div className="space-y-10 sm:space-y-12 lg:space-y-16">
      ...
      {/* How the Neuro Pro 2 works - MOBILE RESPONSIVE */}
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-start p-4 sm:p-6 lg:p-8 xl:p-12">
            <div className="text-white space-y-3 sm:space-y-4 lg:space-y-6">
              ...
              <button
                onClick={() => setSelectedVideoUrl('https://youtu.be/8efsvKidLeQ')}
                className="flex items-center space-x-2 sm:space-x-3 text-white bg-opacity-20 px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3 lg:py-4 rounded-full backdrop-blur-sm hover:bg-opacity-30 transition-colors border border-white border-opacity-30 text-sm sm:text-base lg:text-lg"
              >
      ...
      {/* Video grid section - MOBILE RESPONSIVE */}
          ...
          {[
            ...
            <div key={index} className="bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-sm">
              ...
              <div className="p-3 sm:p-4 lg:p-6 space-y-2 sm:space-y-3">
                ...
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">{video.subtitle}</p>
                <button
                  onClick={() => setSelectedVideoUrl(video.url)}
                  className="flex items-center space-x-1.5 sm:space-x-2 text-[#EA1934] font-medium hover:text-blue-700 transition-colors mt-2 sm:mt-4 text-xs sm:text-sm"
                >
      ...
      {/* Protocol description - MOBILE RESPONSIVE */}
      <div className="relative min-h-[300px] sm:min-h-[400px] lg:min-h-[500px] w-full">
        ...
        {/* Overlay content - MOBILE RESPONSIVE */}
        <div className="relative z-10 flex items-center justify-center sm:justify-end min-h-[300px] sm:min-h-[400px] lg:min-h-[500px] p-4 sm:p-6 lg:p-8">
          <div className="max-w-sm sm:max-w-md space-y-4 sm:space-y-6 bg-white/90 sm:bg-white/10 backdrop-blur-sm p-4 sm:p-6 rounded-xl">
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold text-black">
              9 powerful preset protocols to modulate your brain
            </h2>
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-start space-x-2 sm:space-x-3">
                  <div className="w-2 h-2 sm:w-3 sm:h-3 bg-gray-600 rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
                  <p className="text-gray-800 font-medium text-sm sm:text-base">
                    <strong>The Gracefire protocols</strong> unlock the power of neuromodulation
                  </p>
                </div>
      ...
      <div className="relative min-h-[400px] sm:min-h-[500px] lg:min-h-[600px] w-full rounded-xl sm:rounded-2xl overflow-hidden">
  {/* Background Image */}
  <Image
    src="/community-member-happy.jpg"
    alt="Happy community member"
  ...
  {/* Overlay Content */}
  <div className="absolute inset-0 bg-black/40 sm:bg-black/30 lg:bg-transparent lg:bg-gradient-to-r lg:from-black/60 lg:via-black/40 lg:to-transparent">
    <div className="relative z-10 flex items-center justify-center lg:justify-start h-full p-4 sm:p-6 lg:p-8 xl:p-12">
      <div className="max-w-md lg:max-w-lg space-y-4 sm:space-y-6 text-white text-center lg:text-left">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold">Join the Neuro Pro 2 community</h2>
        ...
        <div className="space-y-2 sm:space-y-3">
          {[
            ...
            <div key={benefit} className="flex items-start space-x-2.5 sm:space-x-3 text-left">
              <div className="w-2 h-2 sm:w-3 sm:h-3 bg-[#EA1934] rounded-full mt-1.5 sm:mt-2 flex-shrink-0"></div>
              <p className="text-xs sm:text-sm lg:text-base">{benefit}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="relative rounded-xl sm:rounded-2xl overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center p-4 sm:p-6 lg:p-8 xl:p-12">
          <div className="max-w-2xl lg:max-w-3xl space-y-4 sm:space-y-6 lg:space-y-8 text-black">
            <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold leading-tight">Feel better with the Neuro Pro 2</h2>
            <p className="text-base sm:text-lg lg:text-xl leading-relaxed">We have over 35 published and ongoing clinical trials with Vielight technology.</p>
            ...
            <button className="bg-white text-[#EA1934] px-6 sm:px-8 py-3 sm:py-4 rounded-full text-sm sm:text-base lg:text-lg font-semibold hover:bg-gray-100 transition-colors">
              See research
            </button>
          </div>
        </div>
      ...
      <div className="space-y-4 sm:space-y-6">
        {[
          ...
          <div key={index} className="bg-gray-200 rounded-xl sm:rounded-2xl overflow-hidden">
            <button
              onClick={() => toggleSection(`faq-${index}`)}
            ...
            >
              <h3 className="text-base sm:text-lg lg:text-xl font-semibold text-black pr-4">{faq.question}</h3>
              ...
              <div className="px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8">
                <div className="space-y-3 sm:space-y-4 text-gray-700 text-sm sm:text-base lg:text-lg leading-relaxed">
                  {faq.answer.split('\n\n').map((paragraph, pIndex) => (
                    <p key={pIndex} className={
                      paragraph.includes(':') && paragraph.length < 50
                        ? 'font-semibold text-black text-base sm:text-lg lg:text-xl'
                        : ''
                    }>
                      {paragraph}
                    </p>
