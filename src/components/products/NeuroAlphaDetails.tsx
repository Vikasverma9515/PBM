// 'use client';
// // components/products/NeuroAlphaDetails.tsx
...
// // Matches structure/theme used by Neuro Pro / Neuro Gamma details.
// // Adds top buy section per request.
// const NeuroAlphaDetails: React.FC<NeuroAlphaDetailsProps> = ({ activeTab, expandedSection, toggleSection }) => {
...
//             alt="Vielight Neuro Alpha 4 overview"
//             width={600}
//             height={500}
...
//             {['Relaxation', 'Mindfulness', 'Sleep quality', 'Mental coordination', 'Cognitive balance'].map((benefit) => (
//               <span
//                 key={benefit}
...
//               The Vielight Neuro Alpha 4 is a transcranial-intranasal photobiomodulation system designed to support a relaxed
//               mental state. It pulses near-infrared light at 10 Hz (Alpha) and is engineered for consistent, comfortable home use.
//             </p>
//             <p className="text-gray-700 leading-relaxed">
//               Its modular headset uses 5 Vie-LEDs to deliver high irradiance safely, with full scalp contact and an intranasal
//               applicator for complementary delivery.
//             </p>
//           </div>
...
//               <span className="font-medium text-black">Alpha mode (10 Hz) neuromodulation</span>
//             </div>
//             <div className="flex items-center space-x-3">
//               <Sun className="w-5 h-5 text-gray-600" />
//               <span className="font-medium text-black">~5000 mW total | up to ~300 mW/cm²</span>
//             </div>
//             <div className="flex items-center space-x-3">
...
//         <button
//           onClick={() => toggleSection('alpha-whats-in-box')}
...
//           {expandedSection === 'alpha-whats-in-box' ? (
...
//       <div className="bg-gray-200 rounded-2xl overflow-hidden">
//         <button
//           onClick={() => toggleSection('alpha-user-guides')}
//           className="w-full px-8 py-6 flex items-center justify-between hover:bg-gray-300 transition-colors"
//         >
//           <h3 className="text-xl font-bold text-black">Guides & tutorials</h3>
//           {expandedSection === 'alpha-user-guides' ? (
//             <Minus className="w-6 h-6 text-black" />
//           ) : (
//             <Plus className="w-6 h-6 text-black" />
//           )}
...
//                 {['Neuro Alpha user guide', 'Intranasal applicator instructions', 'Safety & care'].map((guide) => (
//                   <button
//                     key={guide}
...
//                     src="https://www.youtube.com/embed/VIDEO_ID_ALPHA_1"
//                     title="Neuro Alpha 4 | Setup Guide"
//                     frameBorder={0}
...
//                   <iframe
//                     className="absolute inset-0 w-full h-full"
//                     src="https://www.youtube.com/embed/VIDEO_ID_ALPHA_2"
//                     title="Neuro Alpha 4 | Usage Tips"
//                     frameBorder={0}
//                     allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
//                     allowFullScreen
//                   />
...
//                 <p className="text-gray-600">Stable output at Alpha (10 Hz) mode.</p>
//               </div>
//             </div>
//             <div className="flex items-start space-x-3">
...
//         <h2 className="text-3xl font-bold text-black">How to use Neuro Alpha 4</h2>
...
//             <p className="text-gray-700 text-sm">Run a 20-minute session, ideally evenings/nighttime.</p>
//           </div>
//           {/* Step 3 */}
//           <div className="bg-white rounded-2xl p-6 text-center space-y-4">
//             <div className="relative mx-auto w-48 h-48">
