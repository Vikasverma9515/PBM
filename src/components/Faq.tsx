    ...
    return (
        <div className="w-full min-h-[800px] lg:h-[1200px] bg-[#171717] text-white py-12 lg:py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-[1440px] mx-auto">
                ...
                {/* Still Have Questions Section - UPDATED with Link */}
                <div className="text-center mt-12 lg:mt-20">
                    ...
                    <Link
                        href="/contact"
                        className="inline-block bg-transparent border border-white text-white px-6 lg:px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-black transition-colors"
                    >
                        Contact
                    </Link>
                </div>
