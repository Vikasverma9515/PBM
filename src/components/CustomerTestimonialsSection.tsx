        ...
        <div className="w-full bg-gray-50 py-12 lg:py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12 lg:mb-16">
                    {/* Main Title with Trustpilot Rating */}
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-4 lg:mb-6">
                        <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-black text-center sm:text-left">
                            Our customers say Excellent
                        </h2>
                        ...
                        <div className="flex items-center gap-1 bg-green-500 px-3 py-2 rounded">
                            {[...Array(5)].map((_, i) => (
                                <svg key={i} className="w-4 h-4 lg:w-5 lg:h-5 fill-white" viewBox="0 0 20 20">
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                            ))}
                        </div>
                ...
                <div className="relative">
                    ...
                    <button className="absolute -left-[50px] top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-12 h-12 bg-white rounded-full shadow-lg items-center justify-center hover:bg-gray-50 transition-colors hidden lg:flex">
                        <ChevronLeft className="w-6 h-6 text-gray-600" />
                    </button>
                    
                    <button className="absolute -right-[50px] top-1/2 -translate-y-1/2 translate-x-4 z-10 w-12 h-12 bg-white rounded-full shadow-lg items-center justify-center hover:bg-gray-50 transition-colors hidden lg:flex">
                        <ChevronRight className="w-6 h-6 text-gray-600" />
                    </button>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8">
                        ...
                        <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-sm border border-gray-100">
                            {/* Quote Icon */}
                            <div className="text-[#219653] mb-4 lg:mb-6">
                            ...
                            {/* Testimonial Title */}
                            <h3 className="text-lg lg:text-xl font-bold text-black mb-3 lg:mb-4">A worthwhile investment</h3>
                        ...
                        <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-sm border border-gray-100">
                            ...
                            {/* Testimonial Title */}
                            <h3 className="text-lg lg:text-xl font-bold text-black mb-3 lg:mb-4">Better sleep in 2 months</h3>
                        ...
                        {/* Testimonial 3 */}
                        <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-sm border border-gray-100 sm:col-span-2 md:col-span-1">
                            {/* Quote Icon */}
                            <div className="text-[#219653] mb-4 lg:mb-6">
                                <svg className="w-10 h-10 lg:w-12 lg:h-12" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h4v10h-10z"/>
                            ...
                            {/* Testimonial Title */}
                            <h3 className="text-lg lg:text-xl font-bold text-black mb-3 lg:mb-4">Great for athletes</h3>
