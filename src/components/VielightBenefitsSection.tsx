...
//             {/* Background Image Layer - cropped from top */}
//             <div className="absolute w-[1694px] h-[880px] -top-[215px] -left-[50px]  z-0">
//                 <Image
//                     src="/vielight-benefits-background.jpg"
//                     alt="Vielight benefits background"
//                     fill
//                     className="object-cover"
//                     style={{ objectPosition: 'center 40%' }} // crop more from the top
//                     priority
//                 />
//             </div>

//             {/* Red overlay - separate from background, covers only bottom portion */}
//             <div className="absolute w-full h-[70%] bottom-0 left-0 z-5 bg-red-600/80"></div>
