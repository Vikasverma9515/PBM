...
const EnhancingBrainHealthSection: React.FC = () => {
    return (
        <div className="w-full">
            {/* First Section - Enhancing Brain Health - Desktop unchanged */}
            <div className="w-full lg:h-[414px] bg-white">
                <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 h-full">
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 items-center h-full">
                        
                        {/* Left Column - Main Heading */}
                        <div className="flex items-center lg:pl-15">
                            <h3 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-bold text-black leading-tight">
                                <span className="block">Enhancing Brain Health with</span>
                                <span className="block">Photobiomodulation</span>
                            </h3>
                        </div>
            ...
            {/* Second Section - Published Research - Desktop unchanged */}
            <div className="w-full lg:h-[465px] bg-[#FFF2F4] lg:ml-[2px]">
                <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 h-full">
                    <div className="flex flex-col justify-center h-full space-y-8 lg:space-y-12">
                        
                        {/* Section Title */}
                        <div className="text-center">
                            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-black mb-8 lg:mb-12">
                                Published research with Vielight Technology
                            </h2>
                        </div>
                        ...
                        <div className="space-y-4 lg:space-y-6">
                            ...
                            <div className="flex flex-wrap justify-center gap-3 lg:gap-4">
                                <span className="px-4 lg:px-6 py-2 lg:py-3 border-2 border-red-400 text-red-500 rounded-full font-medium hover:bg-red-50 transition-colors text-sm lg:text-base">
                                    Alzheimer's (Dementia)
                                </span>
                                <span className="px-4 lg:px-6 py-2 lg:py-3 border-2 border-red-400 text-red-500 rounded-full font-medium hover:bg-red-50 transition-colors text-sm lg:text-base">
                                    Immunity
                            ...
                            <div className="flex flex-wrap justify-center gap-3 lg:gap-4">
                                ...
                                {/* View All Research Button */}
                                <button className="px-6 lg:px-8 py-2 lg:py-3 bg-[#EA1934] text-white rounded-full font-semibold hover:bg-red-600 transition-colors flex items-center space-x-2 text-sm lg:text-base">
                                    <span>View all research</span>
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                    </svg>
